...
SimpleForm.setup do |config|
  ...
  config.wrappers :small, :class => 'clearfix', :error_class => :error do |b|
    b.use :placeholder
    b.use :label
    b.use :tag => 'div', :class => 'input small' do |ba|
      ba.use :input
      ba.use :error, :tag => :span, :class => :'help-inline'
      ba.use :hint,  :tag => :span, :class => :'help-block'
    end
  ...
  config.wrappers :horizontal, :tag => :td, :class => "clearfix", :error_class => :error do |b|
    b.use :placeholder
    b.use :hint,  :tag => :span, :class => :'help-block'
    b.use :tag => :div, :class => 'input' do |input|
      input.use :input
